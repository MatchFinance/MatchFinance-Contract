 ...
 *      ! 5) distributing USDT to vlMatch staking
 */
...
contract RewardDistributorV2 {
    ...
    // Factory is the only caller to distribute the reward
    ...
    constructor(address _rewardToken, address _receiver) {
     ...
     */
    function setRewardSpeed(uint256 _newSpeed) external onlyFactory {
    ...
    function distribute() external onlyFactory returns (uint256) {
    ...
    function emergencyWithdraw(address _token, address _to, uint256 _amount) external onlyFactory {
